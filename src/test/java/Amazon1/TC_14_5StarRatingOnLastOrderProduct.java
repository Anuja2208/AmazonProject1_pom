...
public class TC_14_5StarRatingOnLastOrderProduct extends AmazonBaseClass
{
	...
	public void givingRatingforLastOrder(String usernameFromExcel, String passwordFromExcel, String nameFromExcel, String mobileNoFromExcel) throws InterruptedException
	{
		if (driver == null) {
