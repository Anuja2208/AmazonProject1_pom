...
public class TC_10ItemUpdateRemove extends AmazonBaseClass
{
	...
	public void addRemoveproduct(String usernameFromExcel, String passwordFromExcel, String nameFromExcel, String mobileNoFromExcel) throws InterruptedException
	{
		if (driver == null) {
